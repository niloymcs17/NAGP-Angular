...
export class PaymentComponent implements OnInit {
  ...
  constructor(private router: Router, private route: ActivatedRoute, private translate: TranslateService ,private productService: ProductService) { }
  ...
  ngOnInit(): void {
    ...
    } else if(this.productService.cartMap.size == 0) {
